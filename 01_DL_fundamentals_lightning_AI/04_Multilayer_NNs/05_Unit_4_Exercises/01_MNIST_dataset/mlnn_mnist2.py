...
def importData( importPath ):
   ...
   root=importPath, train=True, transform=transforms.ToTensor(), download=True)
   test_dataset = datasets.MNIST(
   root=importPath, train=False, transform=transforms.ToTensor())
...
def main():
   ...
   # Import data #
   importPath = "/Users/isalough/Desktop/ML_DL_TRAINING/01_DL_fundamentals_lightning_AI/04_Multilayer_NNs/02_MNIST_digits/mnist"
   train_dataset, test_dataset = importData( importPath )
